...
public class PowerManagementAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = projectObj.insertProject(request.getParameter("pname"), 
				request.getParameter("pdistrict"),
				request.getParameter("pzipCode"),
				request.getParameter("punits"),
				request.getParameter("ptotal"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = projectObj.updateProject(paras.get("hidProjectIDSave").toString(),
				...
				paras.get("pdistrict").toString(),
				paras.get("pzipCode").toString(),
				paras.get("punits").toString(),
				paras.get("ptotal").toString()
